...
export class ToolConfigManager {
  ...
  getDefaultConfig() {
    return {
      ...
      tools: {},
      _comment: 'Tool configuration for SSH MCP Universal. Run "ssh-manager tools configure" to customize.'
    };
  }
  ...
  exportClaudeCodeConfig() {
    ...
    const autoApprovalPatterns = enabledTools.map(tool => `mcp__ssh-universal__${tool}`);
