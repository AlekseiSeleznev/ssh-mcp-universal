...
Note: this release copy was originally drafted under the older project branding. Commands that use `ssh-manager` still work as legacy-compatible CLI entrypoints, but the current package/repository name is `ssh-mcp-universal` and the canonical MCP identifier is `ssh-universal`.

## Twitter/X Post

🚀 NEW: SSH MCP Universal v3.1.0 - Tool Activation System!
...
Install: `npm i -g ssh-mcp-universal`

📦 https://github.com/AlekseiSeleznev/ssh-mcp-universal
🌟 Star if useful!
...
**Title:** SSH MCP Universal v3.1.0 - Comprehensive SSH automation with 92% context reduction

**Body:**

I've been working on SSH MCP Universal, a Model Context Protocol server that brings comprehensive SSH management to Claude Code (and OpenAI Codex).
...
- GitHub: https://github.com/AlekseiSeleznev/ssh-mcp-universal
- NPM: https://www.npmjs.com/package/ssh-mcp-universal
...
**Title:** Show HN: SSH MCP Universal – 37 DevOps tools for Claude Code with 92% context reduction

**Body:**

Hi HN! I built SSH MCP Universal, a comprehensive Model Context Protocol server for SSH automation with Claude Code and OpenAI Codex.
...
- Repo: https://github.com/AlekseiSeleznev/ssh-mcp-universal
- NPM: https://www.npmjs.com/package/ssh-mcp-universal
- Docs: https://github.com/AlekseiSeleznev/ssh-mcp-universal#readme
...
🚀 Excited to announce SSH MCP Universal v3.1.0!
...
DevOps teams spend hours on repetitive SSH tasks. With SSH MCP Universal, you can ask Claude Code:
...
Check it out: https://github.com/AlekseiSeleznev/ssh-mcp-universal
...
**Title:** "Building an Enterprise DevOps Platform with Model Context Protocol: Lessons from SSH MCP Universal"
...
2. **For users:** "Try it now: `npm install -g ssh-mcp-universal`"
3. **For maintainers:** "Open an issue if you need a feature or fix"
